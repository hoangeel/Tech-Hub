...
export default function Apple() {
  ...
  return (
    <div className={styles.trending + (" ") + styles.apple}>
      <div className={styles.container}>
        <div className={styles.content}>
          <div className={styles.groupApple}>
            <div>
              <h1 className={styles.titleApple}>Apple Shopping Event</h1>
              <div><Button className={styles.ShopNow}>Shop Now</Button></div>
              <br />
              <Image src={apple} alt="apple" className={styles.imgApple}/>
            </div>
